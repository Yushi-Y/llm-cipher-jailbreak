...
if __name__ == "__main__":
    ...
    input_file = "/data/kebl6672/llm_jailbreak/generated_responses/pig_latin_translation_llama3.csv"
    output_file = "/data/kebl6672/llm_jailbreak/generated_responses/pig_latin_full_response_llama3.csv"
